    ...
    <div className="bg-white w-full flex flex-col gap-5 py-7">
        <div className='flex flex-row justify-between px-12'>
          <div className='flex flex-col'>
              ...
              <Select>
                  <SelectTrigger className="w-[300px] rounded-[10px]">
          ...
          <div className='flex flex-col'>
            ...
            <Popover>
                <PopoverTrigger asChild>
                    ...
                    variant={"outline"}
                    className={cn(
                        "w-[250px] justify-between text-left font-normal rounded-[10px]",
        ...
        <div className='flex flex-row justify-between px-12 flex-wrap gap-3'>
            {
                colors.map((index)=>(
                    <div className='flex flex-row p-4 bg-[#F2F9FF] justify-between w-[340px] items-center rounded-[10px]' key={index}>
                        <div className='flex flex-col'>
